...
> **Architecture Overview**: Before starting implementation, the **Code Role** and others should review [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) for a high-level system understanding.
